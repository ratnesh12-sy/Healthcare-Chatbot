...
export default function AdminDashboard() {
    ...
    return (
        <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div>
                <h1 className="text-3xl font-extrabold text-secondary tracking-tight">Command Center</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
                <div className="bg-white p-6 rounded-3xl shadow-soft border border-line flex flex-col relative overflow-hidden group">
                    <div className="absolute top-0 right-0 w-24 h-24 bg-pastel-sky rounded-bl-full -mr-4 -mt-4 transition-transform group-hover:scale-110"></div>
                    <div className="w-12 h-12 bg-pastel-sky text-pastel-skyInk rounded-2xl flex items-center justify-center mb-4 relative z-10 shadow-sm border border-pastel-sky">
                        <Users size={24} />
                    </div>
                ...
                <div className="bg-white p-6 rounded-3xl shadow-soft border border-line flex flex-col relative overflow-hidden group">
                    <div className="absolute top-0 right-0 w-24 h-24 bg-primary-soft rounded-bl-full -mr-4 -mt-4 transition-transform group-hover:scale-110"></div>
                    <div className="w-12 h-12 bg-primary-soft text-primary rounded-2xl flex items-center justify-center mb-4 relative z-10 shadow-sm border border-primary-soft">
                        <FileText size={24} />
                    </div>
                ...
                <div className="bg-secondary p-6 rounded-3xl shadow-2xl border flex flex-col relative overflow-hidden group border-rose-500/30">
                    ...
                    <p className="text-sm font-bold text-white/60 mt-1 relative z-10 uppercase tracking-wider">AI API Queries Handled</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-8">
                ...
                <div className="lg:col-span-2 bg-white rounded-3xl shadow-soft border border-line overflow-hidden">
                    ...
                    <div className="divide-y divide-line">
                        {auditLogs.length === 0 ? (
                            ...
                            auditLogs.map((log, i) => (
                                <div key={i} className="p-4 hover:bg-surface transition-colors flex items-center justify-between">
                                    ...
                                    <span className="text-xs font-bold text-muted bg-surface px-3 py-1 rounded-full uppercase">
                ...
                <div className="lg:col-span-1 bg-white rounded-3xl shadow-soft border border-line overflow-hidden">
                    ...
                    <div className="p-6 space-y-6">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between text-sm font-bold">
                                <span className="text-muted">Spring Boot API</span>
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between text-sm font-bold">
                                <span className="text-muted">Groq LLM Service</span>
